#---------------------------------------------------------------------------------------------------#
#           THIS PROGRAM WILL BE USED FOR CLEANING THE DATASET HOSPITAL DISCHARGE DATE WHICH SHOULD #
#           ON OR AFTER THE ADMISSION DATE. THIS FIELD IS REQUIRED TO GET THE NUMBER OF DAYS IN THE #
#           TO PREPARE THE OUTCOME VARIABLE                                                         #
#---------------------------------------------------------------------------------------------------#
