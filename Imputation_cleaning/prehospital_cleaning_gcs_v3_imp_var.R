...
clean_trauma1=unique_entry(df=clean_trauma1, 
                           ...
                           key_var =incident_id, 
                           new_column = prehospital_gcs_eye_imp)
sum(is.na(clean_trauma1$prehospital_gcs_eye_imp))
...
clean_trauma1=unique_entry(df=clean_trauma1, 
                           ...
                           distinct_var2 = ed_acute_care_disposition_tr17_27, 
                           key_var =incident_id,
                           new_column = prehospital_gcs_verbal_imp)
sum(is.na(clean_trauma1$prehospital_gcs_verbal_imp))
...
clean_trauma1=unique_entry(df=clean_trauma1, 
                           ...
                           distinct_var2 = ed_acute_care_disposition_tr17_27, 
                           key_var =incident_id, 
                           new_column = prehospital_gcs_motor_imp)
sum(is.na(clean_trauma1$prehospital_gcs_motor_imp))
